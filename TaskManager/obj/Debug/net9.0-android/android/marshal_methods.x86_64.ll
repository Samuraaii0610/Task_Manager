...
@assembly_image_cache_hashes = dso_local local_unnamed_addr constant [966 x i64] [
	...
	i64 u0x0fc8fe43ca01a5df, ; 62: MySqlConnector.dll => 194
	i64 u0x1001f97bbe242e64, ; 63: System.IO.UnmanagedMemoryStream => 57
	i64 u0x102a31b45304b1da, ; 64: Xamarin.AndroidX.CustomView => 221
	...
	i64 u0x307fc2307edcd291, ; 186: TaskManager.dll => 0
	i64 u0x308fa4be11ae848e, ; 187: lib_Pomelo.EntityFrameworkCore.MySql.dll.so => 195
	...
	i64 u0x453c1277f85cf368, ; 263: lib_Microsoft.EntityFrameworkCore.Abstractions.dll.so => 176
	...
	i64 u0x64a5253533d1c410, ; 384: MySqlConnector => 194
	i64 u0x64b1529a438a3c45, ; 385: lib_System.Runtime.Handles.dll.so => 105
	i64 u0x65187c31e9326ce8, ; 386: lib_MySqlConnector.dll.so => 194
	...
	i64 u0x66a4e5c6a3fb0bae, ; 393: lib_Xamarin.AndroidX.Lifecycle.ViewModel.Android.dll.so => 244
	...
	i64 u0x7df5df8db8eaa6ac, ; 470: Microsoft.Extensions.Logging.Debug => 186
	...
	i64 u0x7f9351cd44b1273f, ; 481: Microsoft.Extensions.Configuration.Abstractions => 181
	...
	i64 u0x84cd5cdec0f54bcc, ; 500: lib_Microsoft.EntityFrameworkCore.Relational.dll.so => 177
	...
	i64 u0x86b3e00c36b84509, ; 506: Microsoft.Extensions.Configuration.dll => 180
	...
	i64 u0x8842b3a5d2d3fb36, ; 514: Microsoft.Maui.Essentials => 192
	...
	i64 u0x8a399a706fcbce4b, ; 523: Microsoft.Extensions.Caching.Abstractions => 178
	...
	i64 u0x8b9ceca7acae3451, ; 528: lib-he-Microsoft.Maui.Controls.resources.dll.so => 296
	...
	i64 u0x92a09ef81ffbb5eb, ; 558: lib_TaskManager.dll.so => 0
	...
	i64 u0xd5d73a83203cd9ca, ; 801: TaskManager => 0
	...
	i64 u0xe12e27dc45f5d147, ; 843: Pomelo.EntityFrameworkCore.MySql => 195
	...
	i64 u0xe690fffe6af5f4d7, ; 868: Pomelo.EntityFrameworkCore.MySql.dll => 195
	i64 u0xe7bea09c4900a191, ; 869: Xamarin.AndroidX.VectorDrawable.dll => 265
	...
	i64 u0xe86b0df4ba9e5db8, ; 872: lib_Xamarin.AndroidX.Lifecycle.Runtime.Android.dll.so => 240
	...
	i64 u0xe957c3976986ab72, ; 876: lib_Xamarin.AndroidX.Window.Extensions.Core.Core.dll.so => 271
	i64 u0xe98163eb702ae5c5, ; 877: Xamarin.AndroidX.Arch.Core.Runtime => 208
	i64 u0xe994f23ba4c143e5, ; 878: Xamarin.KotlinX.Coroutines.Android => 282
	i64 u0xe9b9c8c0458fd92a, ; 879: System.Windows => 155
	i64 u0xe9d166d87a7f2bdb, ; 880: lib_Xamarin.AndroidX.Startup.StartupRuntime.dll.so => 261
	i64 u0xea5a4efc2ad81d1b, ; 881: Xamarin.Google.ErrorProne.Annotations => 275
	i64 u0xeb2313fe9d65b785, ; 882: Xamarin.AndroidX.ConstraintLayout.dll => 215
	i64 u0xeb6e275e78cb8d42, ; 883: Xamarin.AndroidX.LocalBroadcastManager.dll => 248
	i64 u0xed19c616b3fcb7eb, ; 884: Xamarin.AndroidX.VersionedParcelable.dll => 267
...
@assembly_image_cache_indices = dso_local local_unnamed_addr constant [966 x i32] [
	...
	i32 130, i32 258, i32 226, i32 68, i32 213, i32 66, i32 194, i32 57,
	i32 221, i32 52, i32 43, i32 125, i32 67, i32 81, i32 241, i32 158,
	i32 92, i32 99, i32 255, i32 141, i32 151, i32 209, i32 295, i32 162,
	i32 169, i32 296, i32 183, i32 81, i32 213, i32 4, i32 5, i32 51,
	...
	i32 164, i32 178, i32 0, i32 195, i32 229, i32 52, i32 321, i32 270,
	i32 90, i32 210, i32 35, i32 295, i32 157, i32 9, i32 293, i32 76,
	i32 55, i32 191, i32 289, i32 189, i32 13, i32 269, i32 180, i32 207,
	...
	i32 201, i32 3, i32 307, i32 227, i32 1, i32 114, i32 278, i32 176,
	...
	i32 194, i32 105, i32 194, i32 245, i32 189, i32 111, i32 204, i32 49,
	i32 20, i32 244, i32 220, i32 72, i32 216, i32 155, i32 39, i32 290,
	i32 35, i32 280, i32 38, i32 296, i32 271, i32 108, i32 305, i32 21,
	i32 277, i32 243, i32 193, i32 15, i32 188, i32 79, i32 79, i32 220,
	i32 188, i32 223, i32 250, i32 258, i32 152, i32 21, i32 191, i32 289,
	i32 50, i32 51, i32 279, i32 315, i32 305, i32 94, i32 197, i32 301,
	i32 16, i32 123, i32 298, i32 160, i32 45, i32 275, i32 174, i32 116,
	i32 63, i32 166, i32 180, i32 14, i32 257, i32 111, i32 204, i32 60,
	...
	i32 77, i32 215, i32 131, i32 277, i32 304, i32 83, i32 186, i32 12,
	i32 34, i32 119, i32 285, i32 238, i32 227, i32 85, i32 196, i32 18,
	i32 268, i32 181, i32 236, i32 72, i32 95, i32 165, i32 231, i32 82,
	i32 320, i32 205, i32 210, i32 281, i32 154, i32 36, i32 151, i32 316,
	i32 319, i32 144, i32 56, i32 113, i32 177, i32 211, i32 265, i32 264,
	i32 37, i32 320, i32 180, i32 115, i32 203, i32 14, i32 197, i32 176,
	i32 146, i32 43, i32 192, i32 201, i32 98, i32 284, i32 168, i32 16,
	i32 48, i32 107, i32 97, i32 178, i32 247, i32 27, i32 128, i32 29,
	i32 296, i32 258, i32 128, i32 44, i32 220, i32 226, i32 149, i32 8,
	i32 249, i32 297, i32 310, i32 309, i32 132, i32 308, i32 42, i32 285,
	i32 33, i32 321, i32 46, i32 143, i32 244, i32 190, i32 235, i32 221,
	i32 138, i32 62, i32 132, i32 288, i32 48, i32 160, i32 0, i32 208,
	i32 235, i32 197, i32 233, i32 304, i32 264, i32 46, i32 164, i32 231,
	i32 293, i32 228, i32 300, i32 193, i32 18, i32 8, i32 174, i32 219,
	...
	i32 222, i32 200, i32 181, i32 306, i32 26, i32 249, i32 236, i32 82,
	...
	i32 136, i32 307, i32 310, i32 261, i32 177, i32 199, i32 40, i32 321,
	...
	i32 184, i32 86, i32 301, i32 93, i32 176, i32 183, i32 129, i32 246,
	i32 263, i32 0, i32 186, i32 257, i32 219, i32 262, i32 216, i32 273,
	...
	i32 217, i32 198, i32 125, i32 195, i32 54, i32 110, i32 130, i32 88,
	i32 23, i32 74, i32 129, i32 31, i32 73, i32 241, i32 300, i32 158,
	i32 23, i32 4, i32 170, i32 308, i32 123, i32 299, i32 294, i32 114,
	i32 172, i32 32, i32 3, i32 164, i32 195, i32 265, i32 30, i32 19,
	i32 240, i32 93, i32 36, i32 5, i32 271, i32 208, i32 282, i32 155,
	i32 261, i32 275, i32 215, i32 248, i32 267, i32 76, i32 63, i32 251,
	i32 147, i32 212, i32 121, i32 134, i32 253, i32 276, i32 192, i32 100,
	i32 39, i32 200, i32 293, i32 68, i32 26, i32 75, i32 78, i32 239,
	i32 190, i32 24, i32 152, i32 38, i32 306, i32 208, i32 133, i32 103,
